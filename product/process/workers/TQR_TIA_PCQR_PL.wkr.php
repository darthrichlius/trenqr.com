 ...
 */
class WORKER_TQR_TIA_PCQR_PL extends WORKER  {
...
//            }
    ...
    private function Process() {
        ...
        $this->perfAtPoint($this->tm_start, __LINE__,TRUE);
        $datas = $PHTOTK->phototheque($this->KDIn["oid"],$sec,$dir,null,null,[
            "rfid"      => $rfid,
            "rftm"      => $rftm,
            "fe_mode"   => true
        ]);
...
//        var_dump(__FILE__,__FUNCTION__,__LINE__,$sec,$dir,$fil,$datas);
//        exit();
        
        $FE_DATAS = [
            "anb"       => $PHTOTK->photocount($this->KDIn["oid"],$sec),
            "alist"     => $datas
        ];
