 ...
 * @author arsphinx
 */
class WORKER_TRPG_GTPG_RFOL extends WORKER {
...
//                "art_desc"      => html_entity_decode($art_tab["art_desc"]), //[DEPUIS 27-04-15]
//                "art_desc"      => html_entity_decode(html_entity_decode($art_tab["art_desc"])),//[NOTE 26-04-15] @BOR A cause du fait qu'on utilise VM qui subit une double HTMLENTITIES
//                "art_desc"      => html_entity_decode($art_tab["art_desc"]), //[DEPUIS 22-04-16]
...
//        var_dump($this->KDout["CUser"],$temp,session_id(),$_SESSION["apps"]["ltc"]);
//        exit();
    ...
    public function on_process_out() {
        ...
        if ( $this->KDIn["oid"] ) {
            $PM = new POSTMAN();
            $log_r = $this->Wkr_LogUsertagActy($PM, $this->KDIn["oid"], $_SESSION['sto_infos']->getCurrent_ipadd(), $this->KDIn["srv_curl"], $this->KDIn["srv_curl"], FALSE, $this->KDIn["gvn_eid"], 913, TRUE);
        }
