...
class WORKER_FAQ_GTPG_PRIVACY extends WORKER  {
...
//        $this->endExecutionIfDebug(__FUNCTION__,__LINE__);
    ...
    private function Index () {
         ...
         *      On ajoute les suggestions de profils
         */
        $TQR = new TRENQR($_SESSION["sto_infos"]->getProd_xmlscope());
        $ueid = ( $this->KDout["iauth"] === TRUE ) ? $_SESSION["rsto_infos"]->getAcc_eid() : NULL ;
        $r__ = $TQR->sugg_GetChoosenProfils($ueid,NULL,3);
        if ( $r__ && is_array($r__) ) {
            $this->KDOut["suggs"] = base64_encode(serialize($r__));
        }
    }
    ...
    public function on_process_out() {
         ...
         * [DEPUIS 06-11-15] @author BOR
         */
        $_SESSION["ud_carrier"]["suggs"] = $this->KDOut["suggs"];
