...
class WORKER_STGS_SUBT_ACC extends WORKER  {
...
//            }
    ...
    function SaveForm() {
        ...
        if ( $this->return_is_error_volatile(__FUNCTION__, __LINE__, $IsConf) ) {
            ...
            $args = [
                "accid"     => $this->KDIn["oid"],
                "ins_psd"   => $this->KDIn["datas"]["pseudo"],
                "ins_eml"   => $this->KDIn["datas"]["email"],
                "ins_lng"   => $this->KDIn["datas"]["lang"],
                "locip"     => $this->KDIn["locip"]
            ];

            $TQACC = new TQR_ACCOUNT();
            $FE = $TQACC->onalter_account($args);
            ...
            if ( is_array($FE) && $FE[0] === "DONE" ) {
                ...
                $FE = [
                    "r"     => $FE[0],
                    "anx"   => "/".$FE[1]["pseudo"]."/settings/account"
                ];
