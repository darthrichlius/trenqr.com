 ...
 */
class WORKER_TQR_TBUV_TSR_PL extends WORKER  {
...
//        exit();
        if ( $this->return_is_error_volatile(__FUNCTION__, __LINE__, $perm) ) {
            ...
            if ( $this->KDIn["datas"]["pi"] && $this->KDIn["datas"]["pt"] ) {
                $tsrds = $TST->React_Pull($this->KDIn["datas"]["ti"],$this->KDIn["datas"]["dr"],$this->KDIn["datas"]["pi"],$this->KDIn["datas"]["pt"],TRUE,$OPS); 
...
//        exit();
        ...
        if ( key_exists("oid", $this->KDIn) && $this->KDIn["oid"] ) {
            ...
            switch ($an) {
                case "tlkbrd":
                        $this->Wkr_LogUsertagActy($PM, $this->KDIn["oid"], $_SESSION['sto_infos']->getCurrent_ipadd(), $this->KDIn["datas"]["cu"], $this->KDIn["srv_curl"], TRUE, $this->KDIn["datas"]["tii"], 1242, TRUE, $dr);
                    break;
                case "fksa":
                        $this->Wkr_LogUsertagActy($PM, $this->KDIn["oid"], $_SESSION['sto_infos']->getCurrent_ipadd(), $this->KDIn["datas"]["cu"], $this->KDIn["srv_curl"], TRUE, $this->KDIn["datas"]["tii"], 1243, TRUE, $dr);
                    break;
                case "hview":
                        $this->Wkr_LogUsertagActy($PM, $this->KDIn["oid"], $_SESSION['sto_infos']->getCurrent_ipadd(), $this->KDIn["datas"]["cu"], $this->KDIn["srv_curl"], TRUE, $this->KDIn["datas"]["tii"], 1244, TRUE, $dr);
                    break;
                case "psmn":
                        $this->Wkr_LogUsertagActy($PM, $this->KDIn["oid"], $_SESSION['sto_infos']->getCurrent_ipadd(), $this->KDIn["datas"]["cu"], $this->KDIn["srv_curl"], TRUE, $this->KDIn["datas"]["tii"], 1245, TRUE, $dr);
                    break;
                case "tia-explr":
                        $this->Wkr_LogUsertagActy($PM, $this->KDIn["oid"], $_SESSION['sto_infos']->getCurrent_ipadd(), $this->KDIn["datas"]["cu"], $this->KDIn["srv_curl"], TRUE, $this->KDIn["datas"]["tii"], 1246, TRUE, $dr);
                    break;
                default:
                    break;
            }
