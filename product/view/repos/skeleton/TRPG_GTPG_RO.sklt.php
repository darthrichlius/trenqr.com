...
<!--    <div id="warning_bar_max" class="this_hide">
    ...
    {wos/csam:bugzy}
    {wos/csam:notify_ua}
    <div id="trpg-ovly-max" class="jb-trpg-ovly-mx this_hide">
...
<!--                                <ul id="main-header-ul">
                                    <li id="main-header-li-right"></li>
                                    <li id="main-header-li-left"></li>
                                </ul>-->
                            </div>
                            <div id="tr-header">
                                ...
                                <div id="tr-header-top">
                                    <div id="a-h-t-top-tr" class="resz-tr-hdr-hir">
                                        ...
                                        <div id="a-h-t-top-tr-img-max">
                                            <div id="trpg-cov-delconf-mx" class="jb-trpg-cov-delconf-mx this_hide">
                                                <div id="trpg-cov-dlcf-geninfo-mx" class="jb-trpg-cov-dlcf-gninf-mx this_hide">
                                                    <span id="trpg-cov-dlcf-gninf" class="jb-trpg-cov-dlcf-gninf"></span>
                                                </div>
                                                <div id="trpg-cov-dlcf-wait-mx" class="jb-trpg-cov-dlcf-wait-mx this_hide">
                                                    <span id="trpg-cov-dlcf-wait">Patientez ...</span><i class="fa fa-cog fa-spin"></i>
                                                </div>
                                                <div id="trpg-cov-dlcf-dc-mx" class="jb-trpg-cov-dlcf-dc-mx this_hide">
                                                    <div id="trpg-cov-dlcf-dc-hdr">
                                                        <span id="trpg-cov-dlcf-dc-tle">Voulez-vous vraiment revenir à l'image par défaut ?</span>
                                                    </div>
                                                    <div id="trpg-cov-dlcf-dc-bdy">
                                                        <ul id="trpg-cov-dlcf-dc-dcs-mx">
                                                            <li class="trpg-cov-dlcf-dc-dc-mx"><a class="trpg-cov-dlcf-dc-dc-tgr jb-trpg-cov-dlcf-dc-dc-tgr" data-action="confirm_del_cover" href="javascript:;" role="button">Oui</a></li>
                                                            <li class="trpg-cov-dlcf-dc-dc-mx"><a class="trpg-cov-dlcf-dc-dc-tgr jb-trpg-cov-dlcf-dc-dc-tgr" data-action="abort_del_cover" href="javascript:;" role="button">Non</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php else : ?> 
                                                ...
                                                <span id="trpg-cov-none" class="jb-trpg-cov-none">
                                        ...
                                        <ul>
                                            <li id="tr-h-t-d-1">
                                                <ul id="tr-h-t-d-1-ul" class="">
                                                    ...
                                                    <li class="tr-h-t-d-11">
                                                    </li>
                                                </ul>
                                                <div id="chcov_choices" class="this_hide">
                                                    <a id="c_c_canc" class="chcov_choices_btn jb-chcvr-ch-tgr" data-action="abort_save_cover" href="javascript:;">Annuler</a>       
                                                    <a id="c_c_sauv" class="chcov_choices_btn jb-chcvr-ch-tgr" data-action="confirm_save_cover" href="javascript:;">Sauvegarder</a>       
                                                </div>
                                            </li>
                                            <li id="tr-h-t-d-2">
                            ...
                            <div class="folw-preview">
                                <div id="folw-prvw-bdy">
                                    <div class="action_maximus action_trhome">
                                        <a href="javascript:;" class='action_a action_a_htr'><span class='brain_sp_k'>A</span><span class='brain_sp_action'>ction<span></a>
                                        <ul class='action_foll_choices this_hide'>
                                            <li><a class='afl_choice bind-tr-trpg-edit' data-action='op_trpg_edit' href="javascript:;" role="button">{wos/deco:_trpg_Edit_tr}</a></li>
                                            <li id="a-f-c-sep-tr-chcv">
                                                <a id="tr-chcov-trg-bis" class='afl_choice bind-chtrcov' data-action='start_change' role="button">
                                                    <!--<form>-->
                                                        <input id="tr-chcov-trg" class="jb-tr-chcov-trg" data-action='ch_cover' type="file" autocomplete="off"/>
                                                    <!--</form>-->
                                                    {wos/deco:_trpg_Change_cover}
                                                </a>
                                            </li>
                                            <li>
                                                <a class="afl_choice bind-deltrcov this_hide" data-action='start_del_cover' href="javascript:;" role="button">{wos/deco:_trpg_Delete_cover}</a>
                                            </li>
<!--                                            <li class='afl_choice_sep'></li>
                                            <li><a href="#" class='afl_choice bind-tr-trpg-cr' data-action='op_trpg_cr'>{wos/deco:_trpg_Create_tr}</a></li>-->
                                        </ul>            
                                    </div>
                                    <?php 
                                        $x;
                                ...
                                ?>
                                    <p id="tr_home_gratif">{wos/deco:_trpg_Grat_guide}&nbsp;<a href="javascript:;" class="pts-in-tr-home"><span id="p-i--t-h-nb">{wos/datx:trgrat}</span> <span>coo!</span></a>&nbsp;{wos/deco:_points}.</p>
                                <?php endif; ?>
                            </div>
