    ...
    <div id="ins_screensize">
        <div id="ins_content">
            ...
            <div id="ins_left">
                ...
                <form id="ins_form" action="index.php?page=inscription&urqid=sup_cnxAftInsBuilder" method="POST">
                    ...
                    <div class="ins_group">
                        ...
                        <input spellcheck="false" data-su="ulock" name="ins_input_nickname" id="ins_input_nickname" type="text" class="ins_group_input ins_error_lock" value="{wos/datx:psd}">
                    </div>
                    <div class="ins_group">
                        ...
                        <input data-su="ulock" id="ins_input_mail" type="text" class="ins_group_input ins_error_lock" value="{wos/datx:email}">
                    </div>
                    <div class="ins_group">
                    ...
                    <div class="ins_group">
                        ...
                        <input data-su="ulock" id="ins_input_passwd" name="ins_input_passwd" type="password" class="ins_group_input ins_error_lock" value="{wos/datx:hp}">
                    </div>
                    <div class="ins_group">
