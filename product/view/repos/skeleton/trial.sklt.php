            ...
            <div id="ins_left">
                ...
                <div id="ins_title">
                    <div id="ins_title_content">
                        Cr&eacute;ation de compte d&apos;essai
                    </div>
                </div>
                <div class="tryacc_warning" id="tryacc_creation">
                    <p>Attention, vous &ecirc;tes sur le point de cr&eacute;er un <span class="bold">compte d&apos;essai</span>. Vous aurez acc&egrave;s &agrave; tout le site, comme un compte normal, mais votre compte d&apos;essai expirera automatiquement un mois apr&egrave;s sa cr&eacute;ation. Si vous souhaitez conserver votre compte, vous pouvez &agrave; tout moment le convertir en compte classique.</p>
                </div>
                <form id="ins_form" action="standby.php" method="POST">
                    <div id="ins_first_grp" class="ins_group">
                        ...
                        <input spellcheck="false" data-su="ulock" class="ins_group_input ins_error_lock" id="ins_input_fullname" type="text" value="">
                    </div>
                    ...
                    <div class="ins_group">
                        ...
                        <input spellcheck="false" data-su="ulock" id="ins_input_nickname" type="text" class="ins_group_input ins_error_lock" value="">
                    </div>
                    <div class="ins_group">
                        ...
                        <input data-su="ulock" id="ins_input_mail" type="text" class="ins_group_input ins_error_lock" value='<?php echo html_entity_decode($_SESSION['ud_carrier']['em']) ?>'>
                    </div>
                    <div class="ins_group">
