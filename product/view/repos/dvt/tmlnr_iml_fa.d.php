...
?>
<article id="post-accp-myl-id<?php echo ( isset($article) && key_exists("id", $article ) ) ? $article["id"] : ''; ?>" 
...
>
    ...
    <div class="post-solo-in-acclist">
        <div class="fcb_top">
            ...
            <?php endif; ?>
            <!--
            <div class="fcb_intop_time this_hide">
                <?php 
            ...
            <div id="tqr-art-actbar-mx" class="jb-tqr-art-abr-mx this_hide" data-scp="am-tmlnr-iml">
                <ul id="tqr-art-actbar-lst-mx">
                    <li class="tqr-art-actbar-l-elt">
                        <!-- data-state (ALDY) : Lorsque  -->
                        <!--...-->
                        <!--in_array("time", ["ART_XA_FAV_PUB","ART_XA_FAV_PRI"])
                        <?php $astate = ( isset($article) && key_exists("time", $article ) ) ? $article["time"] : ''; ?>
                        <a class="tqr-art-actbar-tgr jb-tqr-art-abr-tgr" data-css="favorite" data-action="favorite" data-state="<?php echo $astate; ?>" title="Mettre en favoris"></a>
            ...
            <div>
                <div class="rich-post-left-header">
                    <div class="rich-post-left-header-grpuser-max">
                        <p class="rich-post-left-header-grpuser">
                            <a class="rich-post-left-header-grpuser-link" title="<?php echo ( isset($article) && key_exists("ufn", $article ) ) ? $article["ufn"] : ''; ?>" href="<?php echo ( isset($article) && key_exists("uhref", $article ) ) ? $article["uhref"] : ''; ?>">
                                ...
                                <img class="rich-post-left-header-grpuser-link-img" width="45" height="45" src="<?php echo ( isset($article) && key_exists("uppic", $article ) ) ? $article["uppic"] : ''; ?>" />
                    ...
                    <div class="action_maximus arp">
                        ...
                        <ul class='action_foll_choices this_hide'>
                            <li><a class='afl_choice del-the-post' href="javascript:;" role="button" data-action="del_start" data-target="post-accp-myl-id<?php echo ( isset($article) && key_exists("id", $article ) ) ? $article["id"] : ''; ?>">Supprimer la publication</a></li>
                ...
                <div class="rich-post-left-list-comnt-new-max">
                    <div class="arp-nw-react-ipt-mx">
                        <textarea class="arp-nw-react-ipt jb-arp-input" maxlength="1000"></textarea>
                        <a class="arp-nw-react-trg jb-arp-nw-react-trg" href="javascript:;" role="button" data-target="arp-nw-react-ipt">{wos/deco:_Do_it}</a>
                    </div>
                </div>
                ...
                <div class="arp-left-lst-rct-cn">
                    <span class="arp_nb_reacts"><?php echo ( isset($article) && key_exists("rnb", $article ) ) ? $article["rnb"] : ''; ?></span>&nbsp;{wos/deco:_comments1}
                </div>
            </div>
        </div>
        <div class="rich-unik-acclist-child rich-unik-acclist-right">
            <div class="arp-cfrm-bx-mx jb-arp-cfrm-bx-mx this_hide">
                ...
                <div class="arp-cfrm-bx-btm">
                    <a class="arp-del-sbchcs jb-arp-del-sbchcs" data-action="del_confirm" data-target="post-accp-myl-id<?php echo ( isset($article) && key_exists("id", $article ) ) ? $article["id"] : ''; ?>" href="javascript:;">OK</a>
                    <a class="arp-del-sbchcs jb-arp-del-sbchcs" data-action="del_abort" data-target="post-accp-myl-id<?php echo ( isset($article) && key_exists("id", $article ) ) ? $article["id"] : ''; ?>" href="javascript:;">Nooon<i>!</i></a>
                </div>
            </div>
