<!--
    * qsp : Query ScoPe
-->
<div id="asd-srch-max" class="jb-asdapp-modl jb-srh-asd-b" data-modl="roombox">
    <!--<div id="asd-sr-hdr" class="tr">-->
    <div id="asd-sr-hdr" class="jb-asd-sr-hdr tr">
        <div class="asd-sr-hdr-tle">
            <span>Trouver un salon</span>
            <a class="asd-sr-hdr-tle-hlp"></a>
        </div>
<!--        <div id="asd-sr-hdr-catg-max" class="asd-sr-hdr-elts">
            <a class="asd-sr-h-catg-chcs cursor-pointer jb-srh-swh-mn" data-action="fil_menu" data-target="fil_mn_pfl" data-qsp="min" title="Rechercher une Tendance" alt="Lancer une recherche sur une Tendance Trenqr" >R</a>
        </div>-->
        <div id="asd-sr-hdr-ipt" class="asd-sr-hdr-elts">
            <span id="asd-sr-hdr-ipt-wrapl" class="asd-sr-hdr-ipt-wrap"></span> 
            <input id="asd-sr-hdr-ipt-ipt" class="jb-asd-srch-ipt jb-srch-ipt" data-target="fil_mn_trd" data-qsp="min" type="text" name="" placeholder="Titre du Salon" >
