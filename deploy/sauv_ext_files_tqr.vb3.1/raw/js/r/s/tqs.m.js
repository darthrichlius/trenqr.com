...
/******************************************************************************************************************************************************************************************************/
    ...
    var _f_Gdf = function() {
        ...
        var dt = { 
            ...
            menus   : ["custom_filter","custom_color","custom_cropping"],
            grpactn : {
...
//                    URL.revokeObjectURL(img.src);
    ...
    var _f_CvsFit =  function(w,h) {
        try {
            ...
            var wd__ = wh - hs.header - hs.nav - hs.padding;
...
//    alert(Caman(".jb-tqs-canvas") instanceof Caman );
    ...
    $(".jb-tqs-canvas").on({
        'build.cropper': function (e) {
          console.log("CROPPER : ",e.type);
        },
        'cropstart.cropper': function (e) {
          console.log("CROPPER : ",e.type, e.action);
        },
        ...
        'crop.cropper': function (e) {
          console.log("CROPPER : ",e.type, e.x, e.y, e.width, e.height, e.rotate, e.scaleX, e.scaleY);
//          alert("euh !");
        },
        'zoom.cropper': function (e) {
          console.log("CROPPER : ",e.type, e.ratio);
        },
...
//        }, 
    ...
    $(window).resize(function(e){
        ...
        if ( _img ) {
            ...
            console.log("MENU : ", mn, "WIDTH : ",dims.width,"HEIGHT",dims.height);
            /*
             * On redimensionne le canvas en fonction de l'environnement en présence
             */
