...
//                Kxlib_DebugVars(["TBUV_TIME_REF : LANCÉ !"]);
                _f_Srv_PlTsr(prm.ti,prm.dr,prm.pi,prm.pt,xt,x,s);
...
//                Kxlib_DebugVars(["TBUV_TIME_REF : LANCÉ !"]);
                _f_Srv_PlTsl(prm.ti,prm.dr,prm.pi,prm.pt,xt,x,s);
//                alert("Demander les données sur les commentaires au serveur");
...
//                alert(JSON.stringify(md_props));
        ...
        var _f_Srv_PlTsr = function(ti,dr,pi,pt,xt,x,s) {
            if ( KgbLib_CheckNullity(ti) | KgbLib_CheckNullity(dr) | KgbLib_CheckNullity(x) | KgbLib_CheckNullity(xt) | KgbLib_CheckNullity(s) ) {
                return;
            }
...
//                Kxlib_AJAX_HandleFailed("ERR_COM_AJAX_FAIL_TECH");
    ...
    //                Kxlib_AJAX_HandleFailed("ERR_COM_AJAX_FAIL_TECH");
        ...
        var _f_Srv_PlTsl = function(ti,dr,pi,pt,xt,x,s) {
            if ( KgbLib_CheckNullity(ti) | KgbLib_CheckNullity(dr) | KgbLib_CheckNullity(x) | KgbLib_CheckNullity(xt) | KgbLib_CheckNullity(s) ) {
                return;
            }
