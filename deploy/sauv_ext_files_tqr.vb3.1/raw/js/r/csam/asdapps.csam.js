...
function ASDAPPS () {
    ...
    var _f_Gdf = function ()  {
        var ds = {
            //AsdAppsAction
            "aaa" : ["goguidebox","gosearchbox","gochatbox"],
        ...
        try {
            ...
            switch (a) {
                ...
                case "gosearchbox" :
                    ...
                    $bol = $(".jb-asdapp-modl[data-modl='chatbox'], .jb-asdapp-modl[data-modl='guidebox']");
                    
                    //Les selecteurs
                    $sn__ = $(".jb-asd-apps-chc[data-action='gosearchbox']");
                    $so__ = $(".jb-asd-apps-chc[data-action='goguidebox'], .jb-asd-apps-chc[data-action='gochatbox']");
                    break;
                case "gochatbox" :
                    $bnw = $(".jb-asdapp-modl[data-modl='chatbox']");
                    $bol = $(".jb-asdapp-modl[data-modl='searchbox'], .jb-asdapp-modl[data-modl='guidebox']");
                    
                    //Les selecteurs
                    $sn__ = $(".jb-asd-apps-chc[data-action='gochatbox']");
                    $so__ = $(".jb-asd-apps-chc[data-action='gosearchbox'], .jb-asd-apps-chc[data-action='goguidebox']");
                    break;
                default :
                    return;
            }
