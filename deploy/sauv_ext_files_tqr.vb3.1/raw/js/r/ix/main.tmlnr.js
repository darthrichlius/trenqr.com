...
require(["require", "jquery", "jqueryui", "masonry", "twemoji", "punycode", "r/c.c/underscore.min", "r/c.c/bridget", "r/c.c/env.vars", "r/c.c/ajax_rules", "r/c.c/kxlib","r/c.c/perfect-scrollbar-0.4.6.with-mousewheel.min"], 
...
//            require(["r/c.c/kxlib"]);
        ...
        if ( PgEnv ) {
            if ( PgEnv.hasOwnProperty("sector") && PgEnv.sector && $.inArray(PgEnv.sector.toLowerCase(),["tr","fv"]) !== -1 ) {
