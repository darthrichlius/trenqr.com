...
//    this.GetDatasTrArtMdl = function(t) {
        ...
        var f = $(t).closest(".jb-unq-bind-art-mdl").data("cache"), at = $(t).closest(".jb-unq-bind-art-mdl").find(".kxlib_tgspy").html();
//        Kxlib_DebugVars([typeof f,f],true);
        d = Kxlib_DataCacheToArray(f);
...
//                "trtitle"   : d[0][0][4], //[DEPUIS 27-04-15] @BOR
             ...
             */
            var $a = $(t).closest(".jb-unq-bind-art-mdl");
            if ( $a.find(".jb-tqr-cldstrg") && $a.find(".jb-tqr-cldstrg").length ) {
...
//            return;
            ...
            Kxlib_DebugVars([ex,ex.lineNumber,console.trace()],true);
        }
    };
        ...
        //        Kxlib_DebugVars([typeof f,f],true);
                ...
                $(s2).on("datasready",function(e,o,d){
                    ...
                    r = {
                        ...
                        "artpic"    : d.apic,
                        "artdesc"   : d.adesc,
                        "trid"      : ( d.hasOwnProperty("atrid") && d.atrid ) ? d.atrid : null,
                        "trtitle"   : ( d.hasOwnProperty("atrtle") && d.atrtle ) ? d.atrtle : null,
                        //d[0][0][5] correspond à rnb. Dans UNQ on en a pas besoin car on refait une demande auprès du serveur
                        "trhref"    : ( d.hasOwnProperty("atrhrf") && d.atrhrf ) ? d.atrhrf : null,
                        "prmlk"     : d.aprmlk,
                        "time"      : d.atime,
                        "utc"       : null,
                        "alltime"   : at,
                        "ep2"       : ( d.hasOwnProperty("aevals") && d.aevals && $.isArray(d.aevals) && d.aevals.length === 4 ) ? d.aevals[0] : null,
                        "ep1"       : ( d.hasOwnProperty("aevals") && d.aevals && $.isArray(d.aevals) && d.aevals.length === 4 ) ? d.aevals[1] : null,
                        "em1"       : ( d.hasOwnProperty("aevals") && d.aevals && $.isArray(d.aevals) && d.aevals.length === 4 ) ? d.aevals[2] : null,
                        "etl"       : ( d.hasOwnProperty("aevals") && d.aevals && $.isArray(d.aevals) && d.aevals.length === 4 ) ? d.aevals[3] : null,
                        "evlt_u1"   : null,
                        "evlt_u2"   : null,
                        "evlt_u3"   : null,
                        "evlt_tl"   : null,
...
//                    Kxlib_DebugVars([JSON.stringify(d.austgs)],true);
                    if ( d.hasOwnProperty("austgs") && d.austgs && $.isArray(d.austgs) && d.austgs.length ) {
                        var ustgs = d.austgs;
...
//                    Kxlib_DebugVars([JSON.stringify(r.ustgs)],true);
            ...
            Kxlib_DebugVars([ex,ex.linNumber,console.trace()],true);
        }
...
//    this.AddReact = function () {
        try {
            ...
            if ( $(x).hasClass("disabled") 
                    | ( $(".jb-unq-add-rct-ipt").attr("disabled") === true || $(".jb-unq-add-rct-ipt").attr("disabled") === "disabled" ) ) {
                return;
            }
...
//            Kxlib_DebugVars([JSON.stringify(istgs__)],true);
            ...
            e += "<a class=\"unq-react-auth\" href=\"" + d.ohref + "\" alt=\"" + d.ofn + " - " + d.opsd + " on Trenqr\">@" + d.opsd + "</a>";
...
//    this.PrepareArtUnqMdl_Fullfil = function (d) {
        ...
        try {
            if ( KgbLib_CheckNullity(d) | KgbLib_CheckNullity(s) | $.inArray(s,["tmlnr","trpg","nwfd","psmn"]) === -1 ) { 
                return; 
            }
    ...
    //        "+d.time+"
            ...
            var idi = Kxlib_DataCacheToArray(t)[0][1];
            if ( $.inArray(s,["nwfd","psmn"]) !== -1 ) {
                $(".jb-unq-nav-btn").addClass("this_hide");
            } else {
...
//            $(o).find("#unq-u-b-owr-grp").append(pp);
            $(o).find("#unq-u-b-owr-grp").attr("href", d.uhref);
...
//    this.PrepareArtUnqMdl = function (d) {
    ...
    //        alert("JohnDoe => "+e);
            $.each(_rdl,function(x,v){
                ...
                e += "</div>";
                e += "<div class=\"unq-react-txt\">";
                e += "<a class=\"unq-react-auth\" href=\"\">@"+v.upsd+"</a>";
...
//            e += "<a class=\"u-a-a-choices\" data-action=\"delete\" href=\"\" title=\"Delete Post\" alt=\"Supprimer le post sur trenqr\">Supprimer</a>";
            ...
            e += "<a id=\"unq-u-b-owr-grp\" href=\""+d.uhref+"\">";
