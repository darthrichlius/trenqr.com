        ...
        try {
            ...
            switch (ac) {
                ...
                case "xtra-txt-txt" :
                    ...
                    break;
                case "brn-img-cstm-rot-l" :
                case "brn-img-cstm-rot-r" :
                case "brn-img-cstm-ccl" :
                        _f_ImgCstmAx(ac,x,e);
                    break;
                default :
                    return;
...
//                    Kxlib_DebugVars([!$(".jb-fd-w-loadm").hasClass("this_hide"),cn],true);
                 ...
                 *      On ajoute l'ARTICLE
                 * [NNOTE 17-07-16]
                 *      S'il s'agit d'un ARTICLE de type HOSTED, on ne l'affiche pas dans la LISTE
                 */
                if (! d.ihstd ) {
               ...
               _f_XtraImgCstm();
                 ...
                 * [NOTE 17-07-16]
                 */
                var ua_ms_cd = (! d.ihstd ) ? "ua_new_artiml" : "ua_new_ihstd";
                Nty.FromUserAction(ua_ms_cd);
            ...
            if (! $("#inDncPreview img").length ) {
                fds = {
                    ...
                    "opts" : {
                        ...
                        ihosted     : ( $(".jb-brain-menu-action.selected").data("action") === "add-art-hstd" ) ? true : false,
                        "xtrabar"   : xtrabar,
                        "orien"     : []
                    }
                };
                ...
                fds = {
                    ...
                    "opts" : {
                        ...
                        "xtrabar"   : xtrabar,
                        "orien"     : ( $("#inDncPreview img").data("iCsRotAngle") ) ? {
                            "ang" : $("#inDncPreview img").data("iCsRotAngle") 
                        } : 0
                    }
                };
            }
    ...
    var _f_Sharon = function (x) {
        try {
            ...
            if ( $(x).data("art-mdl") !== "on_unq" ) {
                ...
                //*/
                var dc__ = Kxlib_DataCacheToArray($(x).closest(".jb-tqr-fav-bind-arml").data("cache"));
...
//                            $(".brain-th-com[data-sec='nwiml']").addClass("pod");
    ...
    var _f_XtraImgCstm = function(shw) {
        try {
            if ( shw ) {
                $(".jb-tqr-brn-nwpst-orien").removeClass("this_hide");
            } else {
                $(".jb-tqr-brn-nwpst-orien").addClass("this_hide");
            }
        } catch (ex) {
            Kxlib_DebugVars([ex,ex.fileName,ex.lineNumber],true);
        }
    ...
    var _f_ImgCstmAx = function(a,x,e) {
        try {
            if ( KgbLib_CheckNullity(a) |  KgbLib_CheckNullity(x) | KgbLib_CheckNullity(e) ) {
                return;
            }
            
            if (! ( $("#inDncPreview img") && $("#inDncPreview img").length ) ) {
                return;
            }
            var $img = $("#inDncPreview img");
            
            var angle = ( $img.data("iCsRotAngle") ) ? parseInt($img.data("iCsRotAngle")) : 0;
            switch (a) {
                case "brn-img-cstm-rot-l" :
                        angle -= 90;
                ...
                case "brn-img-cstm-rot-r" :
                    ...
                    break;
                case "brn-img-cstm-ccl" :
                        $($img).removeProp("style");
                        $($img).data("iCsRotAngle",0);
                    break;
                default :
                    return;
            }
...
//    }, 5000 ); //DEV, TEST, DEBUG
    ...
    */
    ...
    $(".jb-tqr-brn-nwpst-or-ax").click(function(e){
        Kxlib_PreventDefault(e);
