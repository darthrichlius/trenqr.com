...
//                    break;
    ...
    var _f_PostAdd = function (x) {
        try {
            ...
            /*
             * [DEPUIS 15-07-16]    
             *      Permet de reinitialiser la zone
             */
            $(txar).removeProp("style");
...
//            }
             ...
             */
            var t__ = $("#header").outerHeight() - 345 ;
...
//        Kxlib_DebugVars("TOP : "+$(this).scrollTop());
        ...
        */
        if ( $(".jb-asd-apps-pin-btn").length && $(".jb-asd-apps-pin-btn").attr("data-state") === "ulock" ) {
            ...
            if ( $(".jb-aside-mods") && $(".jb-aside-mods").length && $(this).scrollTop() >= 345 ) {
...
//                return;
                ...
                if ( $.inArray(scp,["on_unq","on_page"]) !== -1 && atype && $.inArray(atype,["psmn"]) === -1 ) {
                     ...
                     *      La mise à jour se fait selon les cas.
                     */
                    if ( !$(idi).find(".jb-tqr-art-abr-tgr").length && $.inArray($(idi).data("atype"),["fav","tia-phtotk","tia-explr"]) === -1 ) {
                        $(x).data("lk",0);
                        return;
                    } 
                    /*
