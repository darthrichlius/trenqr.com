...
//                alert("PM_" + d.wha + d.pvw_tab.pvwbody);
            ...
            else if ( $.inArray(d.wha.toUpperCase(),["UAT_XFAV_ART_FVOMI"]) !== -1 ) {
                at = Kxlib_getDolphinsValue("PM_" + d.wha + d.pvw_tab.pvwbody_xtra);
//                alert("PM_" + d.wha + d.pvw_tab.pvwbody_xtra);
                nat = ( d.hasOwnProperty("slv_prmlk") && !KgbLib_CheckNullity(d.slv_prmlk) ) ? Kxlib_DolphinsReplaceDmd(at, "prmlk", d.slv_prmlk) : at;
            } 
            else {
                nat = at;
...
//                        } else if ( wha__ === "UAT_XUSTG_ART" ) {
                        } else if ( $.inArray(wha__,["UAT_XUSTG_ART","UAT_XFAV_ART_FVOMI"]) !== -1 ) {
                            obtp = "article";
