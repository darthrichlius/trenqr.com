        ...
        //        Kxlib_DebugVars([typeof f,f],true);
                ...
                $(s2).on("datasready",function(e,o,d){
                    ...
                    r = {
                        "itemid"    : d.id,
                        "artpic"    : d.img,
                        "vidu"      : d.vidu, //[DEPUIS 06-07-16] @BOR
                        "artdesc"   : d.msg,
                        ...
                        /*
                         * [DEPUIS 08-07-16]
                         *      Mise en place de la vérification de TripleEval du fait de la particularité de SOD
                         */
                        "te_ena"    : d.te_ena
                    };
        ...
        try {
            ...
            if ( vr === "ajca-v10" && jds ) {
                ...
                */
                ...
                var s2__ = "<span class='tgs-val'></span>";
                var s3__ = "<span class='tgs-uni'></span>";
                var s4__ = s1__.toString()+s2__.toString()+s3__.toString();

                var at  = ( $(b).find(".kxlib_tgspy").length ) ? $(b).find(".kxlib_tgspy").html() : s4__;
...
//            Kxlib_DebugVars([JSON.stringify(jds)],true);
//            Kxlib_DebugVars([JSON.stringify(jds.ustgs),JSON.stringify(jds.hashs)],true);
//            return;
...
//                Kxlib_DebugVars([DEL_RCT => Lock"]);
           ...
           /*
            * [DEPUIS 30-04-15] @BOR
            *       On masque ("this_invi") le commentaire pour empecher l'utilisateur de cliquer une deuxieme fois sur le bouton.
            *       De plus, on bloque aussi le bouton.
            * [DEPUIS 28-07-16]
            *       On "this_hide" 
            */
//            $(x).closest(".jb-unq-react-mdl").addClass("this_invi"); 
            $(x).closest(".jb-unq-react-mdl").addClass("this_hide"); 
            $(x).data("lk",1);
...
//    this._GetAllReactsLimit = function (i) {
        ...
        try {
            ...
            $(s).on("datasready", function(e,d) {
                ...
                * [DEPUIS 08-07-16]
                *   Pas forcement car le cas de SOD est spécial. En effet, USER a doit aux 3 EVALs qui si FRD ou DFLOW
                */
//                $(".jb-css-csam-eval-chs-wrp").removeClass("this_hide");
...
//            $(o).find(".jb-unq-artdesc-box span").text("").append($("<div/>").html(d.artdesc).text());
             ...
             * [DEPUIS 08-07-16]
             */
            else if ( d.hasOwnProperty("te_ena") && d.te_ena === false ) {
                $(o).find(".jb-css-csam-eval-chs-wrp[data-scp='spcl']").addClass("this_hide");
                $(o).find(".jb-css-csam-eval-chs-wrp[data-scp='dslk']").addClass("this_hide");
            }
